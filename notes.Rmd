...
* get rid of xml reference in `process_gradient_`

* Recursive gradient href.

* Number scientific notation beyond transform matrices.

* Preserve aspect ratio when both width/height are 100%?  That seems to be the
  default based on fill-rule.svg.

* Examples subsetting the flattened list and plotting part of the thing.

* Scale to fit so that we can resize things
