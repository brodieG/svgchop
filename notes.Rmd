...
* Think more carefully about how we want to handle path closing.  Should only
  explicitly closed paths be marked as closed?  Should open paths be drawn with
  both a polypath with NA stroke and a line to replicate how they are rendered
  by SVG renderers?
